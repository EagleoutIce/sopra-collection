...
\subsection{Warum, wieso, weshalb?}
    ...
    Das zugehörige Paket sollte ebenfalls in dieses Dokument eingebettet sein: \attachTex{sopra-attachments.sty}.
\subsection{Abhängigkeiten}
    ...
    \begin{multicols}{3}
        \begin{itemize}
            ...
            \foreach \pkg in {xcolor:,attachfile2:,graphicx:{\jmark[\T{attsymbols}]{mrk:attsymbols}}} {
...
In Version \thesoaversion{} (\cmdref{thesoaversion}) gibt es keine weiteren
Besonderheiten.
