...
\subsection{Abhängigkeiten}
    ...
    \begin{multicols}{3}
        \begin{itemize}
            ...
            \foreach \pkg in {xcolor:,attachfile2:,multicol:,LILLYxLISTINGS:{nur \jmark[\T{listings}]{mrk:listings}},blindtext:{nur \jmark[\T{dummy}]{mrk:dummy}},
                hyperref:} {
...
\end{plainlatex}
    ...
    In Version \thesodversion{} (\cmdref{thesodversion}) gibt es keine weiteren
    Besonderheiten.
