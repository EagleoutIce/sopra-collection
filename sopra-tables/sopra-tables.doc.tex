...
\subsection{Abhängigkeiten}
    ...
    \begin{multicols}{3}
        \begin{itemize}
            ...
            \foreach \pkg in {tabu:{\jmark[\T{usetabu}]{mrk:usetabu}},booktabs:{\jmark[\T{notabu}]{mrk:usetabu}},makecell:,longtable:,xcolor:} {
...
\end{mltabular}
\end{latex}
\textit{Ergibt \notetext{Hinweis: der extra Abstand hier ist künstlich und dient der Veranschualichung eiens Seitenumbruchs}:}\vspace*{4cm}
