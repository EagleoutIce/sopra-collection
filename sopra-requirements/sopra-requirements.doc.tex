...
\subsection{Abhängigkeiten}
    ...
    \begin{multicols}{3}
        \begin{itemize}
            ...
            \foreach \pkg in {tabu:{\jmark[\T{usetabu}]{mrk:usetabu}},booktabs:{\jmark[\T{notabu}]{mrk:usetabu}},colortbl:{\jmark[\T{usetabu}]{mrk:usetabu}},makecell:,longtable:,xcolor:,environ:,amssymb:,hyperref:} {
