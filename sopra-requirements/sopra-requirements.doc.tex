...
\subsection{Abhängigkeiten}
    ...
    \begin{multicols}{3}
        \begin{itemize}
            ...
            \foreach \pkg in {tabu:{\jmark[\T{usetabu}]{mrk:usetabu}},booktabs:{\jmark[\T{notabu}]{mrk:usetabu}},makecell:,longtable:,hyperref:} {
...
\begin{command}{thesorversion}{}
    ...
    \notetext{Hinweis: über \blatex{\\value\{thesorversion\}} lässt sich
    die Version als $4$-stellige Nummer erhalten: \arabic{thesorversion}.}
\end{command}
...
\begin{command}{preqref}{\manArg{Anforderungsmarker}}
    Dieser Befehl setzt einen Verweis auf eine mittels \envref{requirement} gesetzt Anfroderung. Für jede werden zwei gültige Marker generiert: \begin{itemize}
    ...
    Bezeichner der Anforderung nicht ausgegen, sondern nur das Kürzel (zum Beispiel \T{FA42}) samt der Seite auf der die Anforderung definiert wird.
\end{command}
...
\begin{requirements}{functional}
    ...
    \begin{requirement}{feed-ducks}
        ...
        \setDescription{Es muss möglich sein, die Enten aus \preqref{FA1} zu füttern}
