...
\end{plainlatex}
    ...
    \begin{argument}{guardspace}{noguardspace}
        Mit \emph{Guardspace} werden dem Listing jeweils auch zugesichert, dass es die nächste Zeile setzen darf. Dies kann dafür sorgen, dass ein Seitenumbruch erzeugt wird (wenn weniger als eine Zeile des Listings noch auf die Seite passt). Der Zweck dieser Option ist es, bei einer Hintergrundfarbe anfängliche Streifen zu vermeiden.
    \end{argument}
...
\begin{command}{solguard}{\manArg{Zeilen}}
    Mit der Paketoption \argref{noguardspace}{guardspace}
\end{command}
