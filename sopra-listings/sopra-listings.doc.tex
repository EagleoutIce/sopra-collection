...
\begin{command}{solblacklistlinenumbers}{\optStar\manArg{Zeilennummern}}
    ...
    Dies kann auch über den optionalen Stern geregelt werden (\cmdref{solblacklistisghost} ist standard, mit Stern wird \cmdref{solblacklistispresent} ausgeführt).
